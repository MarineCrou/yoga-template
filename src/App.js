...
const tiers = [
  {
    ...
    features: ["4 yoga classes card", "Available 6 months", "Use whenever"],
    featured: false,
  },
  {
    ...
    <div className="bg-orange-50">
      ...
      <main>
        ...
        <div className="relative isolate overflow-hidden bg-gray-900 pt-14 pb-16 sm:pb-20">
          <img
            alt=""
            src="https://cdn.pixabay.com/photo/2020/08/06/07/49/woman-5467227_1280.jpg"
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm/6 text-orange-500 ring-1 ring-white/10 hover:ring-white/20">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <a href="/" className="text-sm/6 font-semibold text-white">
                    Online videos <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="mt-32 sm:mt-56">
          ...
          <div className="relative overflow-hidden pt-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <img
                alt="App screenshot"
                src="https://media.istockphoto.com/id/1204500520/fr/photo/lorsque-vous-croyez-vous-recevrez.jpg?s=612x612&w=0&k=20&c=SRgceO95c8zYVKznwVZqYXaLzh_i4tl6TSE5QnCRKJQ="
                width={2432}
                height={1442}
        ...
        <About className="mt-32 sm:mt-56" />
